...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? HomePageLoggedWidget() : HomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? HomePageLoggedWidget()
              : HomePageWidget(),
          routes: [
            FFRoute(
              name: 'HomePage',
            ...
            FFRoute(
              name: 'HomePageLogged',
              path: 'homePageLogged',
              builder: (context, params) => HomePageLoggedWidget(),
            ),
            FFRoute(
              name: 'mobileapps',
              path: 'mobileapps',
              builder: (context, params) => MobileappsWidget(),
            ),
            FFRoute(
              name: 'teamMembers',
              path: 'teamMembers',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/986400000068.png',
                      width: 500,
                      fit: BoxFit.cover,
                    ),
                  ),

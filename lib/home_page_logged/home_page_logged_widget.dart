...
class HomePageLoggedWidget extends StatefulWidget {
  const HomePageLoggedWidget({Key? key}) : super(key: key);

  @override
  _HomePageLoggedWidgetState createState() => _HomePageLoggedWidgetState();
}

class _HomePageLoggedWidgetState extends State<HomePageLoggedWidget> {
  late HomePageLoggedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageLoggedModel());
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child:
                                                              ...
                                                              valueOrDefault<
                                                                  String>(
                                                                currentUserPhoto,
                                                                'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/mcxt-token-n6rg00/assets/d4700hjczt2s/icon-256x256.png',
                                                              ),
                                                              width: 100,
                                                              height: 100,
                                                              fit: BoxFit.cover,
                                                                            ...
                                                                            children: [
                                                                              AuthUserStreamWidget(
                                                                                builder: (context) => Text(
                                                                                  'MCXT ${valueOrDefault(currentUserDocument?.mcxttoken, 0).toString()}',
                                                                            ...
                                                                            children: [
                                                                              AuthUserStreamWidget(
                                                                                builder: (context) => AutoSizeText(
                                                                                  valueOrDefault(currentUserDocument?.mcxtWalletAddress, '').maybeHandleOverflow(
                                                                                    maxChars: 15,
                                                                                    replacement: '…',
                                                                                  ),
                                                                                  style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Image.asset(
                                                                                'assets/images/png-transparent-bnb-cryptocurrencies-icon-thumbnail-removebg-preview.png',
                                                                                width: 44,
                                                                                height: 44,
                                                                                fit: BoxFit.contain,
                                                                              ),
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Image.asset(
                                                                                'assets/images/pngtree-yellow-bitcoin-free-map-image_1369249-removebg-preview.png',
                                                                                width: 44,
                                                                                height: 44,
                                                                                fit: BoxFit.cover,
                                                                              ),

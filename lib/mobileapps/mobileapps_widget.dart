...
import 'mobileapps_model.dart';
export 'mobileapps_model.dart';

class MobileappsWidget extends StatefulWidget {
  const MobileappsWidget({Key? key}) : super(key: key);
...
class _MobileappsWidgetState extends State<MobileappsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MobileappsModel());
